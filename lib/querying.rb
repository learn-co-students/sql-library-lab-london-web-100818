...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series LEFT JOIN characters ON series.id=characters.series_id WHERE species=('human') GROUP BY series.title ORDER BY COUNT(species) DESC LIMIT 1"
end
